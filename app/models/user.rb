...
class User < ApplicationRecord
  ...
  def default_user_profile
    ...
    ['business strategy', 'app development', 'app design', 'mobile app', 'CEO marketing', 'UI & UX design'].each do
    |feature_title|
    ...
    FactoryBot.create(:work_history, user: self, title: 'The Personal Portfolio Mystery', employment_type: 0, company_name: 'Company A',
                      start_date: DateTime.iso8601('2018-01-01', Date::ENGLAND),
                      end_date: DateTime.iso8601('2020-01-01', Date::ENGLAND), currently_employed: true, visibility: true)
